...
if __name__ == "__main__":
   ...
   while True:
      ...
      try:
        ...
        if (c==1114000.62):
          print("Error reading the sensor at " + str(datetime.datetime.now()))
          continue
        ...
        if (avg_index == len(avg_items_r)):
          ...
          #print("Send data:",t,avg_aqi,avg_c,avg_r)
          ...
          print("  Current AQI: " + str(avg_aqi) + "   Time: " + str(datetime.datetime.now()))
